...
# Legacy AEM/Splunk tab: docs/USER_GUIDE.md
# Stops any existing Streamlit or static HTTP server for this project first.
#
# Usage:
#   ./scripts/debug/start_dashboard.sh          # stop conflicts, init, start
#   ./scripts/debug/start_dashboard.sh stop     # stop only (no start)
#   STREAMLIT_PORT=8502 ./scripts/debug/start_dashboard.sh
